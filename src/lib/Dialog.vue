<template>
  <div class = "des-dialog-overlay">
    <div class = "des-dialog-wrapper">
      <div class = "des-dialog">
        <div class = "des-dialog-close-icon">
          <svg class = "icon" height = "16" p-id = "10885" t = "1644070590318" version = "1.1" viewBox = "0 0 1024 1024"
        ...
        <footer>
          <Button level = "lesser" theme = "text">Cancel</Button>
          <Button>OK</Button>
        </footer>
      </div>
    </div>
